...
INSERT INTO `bodystate` VALUES
  (NULL, '2016-01-11', 141, 38000, 5),
  (NULL, '2015-06-07', 150, 46000, 20),
  (NULL, '2016-02-03', 116, 41000, 13),
  (NULL, '2015-08-11', 140, 50000, 2),
  (NULL, '2016-04-08', 109, 46000, 11),
  (NULL, '2016-05-03', 150, 32000, 8),
  (NULL, '2016-02-17', 125, 39000, 12),
  (NULL, '2015-09-06', 92, 31000, 16),
  (NULL, '2015-08-06', 102, 47000, 4),
  (NULL, '2016-02-02', 95, 47000, 5),
  (NULL, '2015-08-01', 107, 33000, 18),
  (NULL, '2015-06-22', 119, 44000, 5),
  (NULL, '2015-08-08', 147, 40000, 14),
  (NULL, '2015-12-16', 134, 46000, 3),
  (NULL, '2016-02-08', 97, 31000, 17),
  (NULL, '2015-11-01', 123, 38000, 1),
  (NULL, '2015-07-13', 124, 33000, 2),
  (NULL, '2015-12-26', 117, 40000, 11),
  (NULL, '2016-04-08', 116, 35000, 6),
  (NULL, '2016-04-03', 107, 49000, 8);
UNLOCK TABLES;
